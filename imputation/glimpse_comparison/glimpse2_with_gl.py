...
if __name__ == '__main__':
    ...
    for n in range(1, 23):
        ...
        b = hb.Batch(backend=backend,
                     name=f'GLIMPSE2-chr{n}-20KEMRI-using_GLs')  # define batch for each chromosome
        ...
        b.write_output(run_ligate_chunks.ofile, f'gs://bge/glimpse2/20KEMRI/glimpse2_imputation_with_gl/gl.imputed.ligated.chr{n}')
